...
import (
	...
	"github.com/juncachain/juncachain/console/prompt"
	"github.com/juncachain/juncachain/eth"
	...
	_ "github.com/juncachain/juncachain/eth/tracers/js"
	_ "github.com/juncachain/juncachain/eth/tracers/native"

	"github.com/urfave/cli/v2"
)

const (
	clientIdentifier = "junca" // Client identifier to advertise over the network
)
...
var (
	...
	app = flags.NewApp(gitCommit, gitDate, "the juncachain command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2023 Juncachain"
...
func prepare(ctx *cli.Context) {
	...
	case ctx.IsSet(utils.JuncaTestnetFlag.Name):
		log.Info("Starting Junca on Junca testnet...")

	case ctx.IsSet(utils.JuncaFlag.Name):
		log.Info("Starting Junca on Junca mainnet...")
...
`)
	...
	if ctx.String(utils.SyncModeFlag.Name) != "light" && !ctx.IsSet(utils.CacheFlag.Name) && !ctx.IsSet(utils.NetworkIdFlag.Name) {
		...
		if !ctx.IsSet(utils.RopstenFlag.Name) &&
			...
			!ctx.IsSet(utils.JuncaTestnetFlag.Name) &&
			!ctx.IsSet(utils.JuncaFlag.Name) &&
