...
func TestEncodeDecode(t *testing.T) {
	...
	extra.Epoch.Validators = append(extra.Epoch.Validators, common.BigToAddress(big.NewInt(1)))
	...
	if new(big.Int).SetBytes(newExtra.Epoch.Validators[0].Bytes()).Cmp(big.NewInt(1)) != 0 {
