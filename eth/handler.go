...
import (
	...
	"github.com/juncachain/juncachain/eth/fetcher"
...
func newHandler(config *handlerConfig) (*handler, error) {
	...
	h.downloader = downloader.New(h.checkpointNumber, config.Database, h.eventMux, h.chain, nil, h.removePeer, h.BroadcastBlock, success)
