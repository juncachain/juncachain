...
func CopyHeader(h *Header) *Header {
	...
	if len(h.Verification) > 0 {
		cpy.Verification = make([]byte, len(h.Verification))
		copy(cpy.Verification, h.Verification)
	}
	if len(h.Extra) > 0 {
...
func (b *Block) Verification() []byte     { return common.CopyBytes(b.header.Verification) }
